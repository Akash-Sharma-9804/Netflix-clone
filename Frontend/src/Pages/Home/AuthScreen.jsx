  ...
  return (
    <div className="hero-bg relative">
      ...
      <header className="max-w-6xl mx-auto flex items-center justify-between p-4 pb-10">
        <img src="/netflix-logo.png" alt="netflix-logo" className="w-40   " />
      ...
      <div className="flex flex-col items-center justify-center text-center py-40 text-white max-w-6xl mx-auto">
        ...
        <form
          ...
          <input
            ...
            className="p-2 rounded flex-1 bg-black/80 border border-gray-700 hover:border-green-400"
            value={email}
            onChange={(e) => setEmail(e.target.value)}
          />
          <button className="bg-red-600 text-xl lg:text-2xl px-3 lg:px-6 py-3 md:py-2 rounded flex justify-center items-center hover:bg-red-700">
            Get Started
...
">
       ...
       <section className="faq bg-black text-white p-8">
  <h2 className="text-center font-bold text-4xl">Frequently Asked Questions</h2>
  <div className="faqbox flex justify-between bg-gray-800 p-6 mx-auto my-8 cursor-pointer transition-all ease-out hover:bg-gray-600 max-w-4xl">
